...
export const metadata: Metadata = {
  title: 'Builtin AI Agents — Browse & Install',
  description:
    'Browse the AI agents that ship with agentget. Each agent handles planning, execution, orchestration, research, or review. Install with a single command.',
  alternates: { canonical: 'https://agentget.sh/docs/agents' },
};
    ...
    <>
      ...
      <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
        ...
        <section className="max-w-3xl">
          <p className="text-sm uppercase tracking-[0.2em] text-neutral-500">Builtin Agents</p>
          <h1 className="mt-4 text-4xl font-bold tracking-tight sm:text-5xl">
            Browse the agents that ship with agentget.
          </h1>
          <p className="mt-5 text-base leading-7 text-neutral-400 sm:text-lg">
            Each agent page is generated from the markdown source in this repo, so the docs route
            stays aligned with the actual builtins you install.
          </p>
        </section>
        ...
        <section className="mt-12 grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {BUILTIN_AGENTS.map((agent) => (
            ...
            >
              ...
              <p className="mt-3 flex-1 text-sm leading-7 text-neutral-400">{agent.summary}</p>
